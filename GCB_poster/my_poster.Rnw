...
signalP 4.1 (no tm) & 0.8235 & 0.9100 & 0.6872 & 0.8667 \\ 
   \rowcolor[gray]{0.85}signalP 4.1 (tm) & 0.6471 & 0.9431 & 0.6196 & 0.7951 \\ 
  ...
  PrediSi & 0.3333 & \textbf{0.9573} & 0.3849 & 0.6453 \\ 
   \rowcolor[gray]{0.85}Philius& 0.6078 & 0.9336 & 0.5684 & 0.7707 \\ 
